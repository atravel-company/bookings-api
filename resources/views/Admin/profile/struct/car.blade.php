        ...
        <p>
                ...
                {{ Form::open(array('id'=>'form_cars_'.$key.'_'.$key1, 'name'=>'form_cars_'.$key.'_'.$key1, 'method'=>'GET')) }}
                    ...
                    <table class="w3-table w3-striped w3-centered car-table">
                        ...
                        @foreach($cars[$key][$key1] as $key2=>$car)
                            <input type="hidden" name="car_id{{$key}}_{{$key1}}_{{$key2}}" value="{{$car['id']}}">
                            <input type="hidden" name="pedido_produto_id{{$key1}}" value="{{$car['pedido_produto_id']}}">
                            <tr>
                                @if(in_array(Auth::user()->email, $users_array))
                                    <td style="text-align:center;"> <!-- Transfer Remove -->
                                        <span class="remove-car" onclick="return confirm('Are you sure you want to delete?')?removeRow({{$car['id']}}, {{$key}}, $(this), 'car'):'';"><i class="fa fa-minus-circle fa-2x" aria-hidden="true"></i></span>
                                    </td>
                                @endif
                                <td> <!-- Pickup Local -->
                                    <input type="text" name="car_pickup_name_{{$key}}_{{$key1}}_{{$key2}}" value="{{$car['pickup']}}" class="form-control">
                                </td>
                                <td> <!-- Pickup Data -->
                                    <div class="form-group" style="width: 140px;">
                                        <div class='input-group date datetimepicker{{$key}}_{{$key1}}_{{$key2}}' id='datetimepicker14' style="position: relative;">
                                            <div style="position: absolute;" id="checkin_car{{$key}}_{{$key1}}_{{$key2}}"></div>
                                            <input value="{{  Carbon\Carbon::parse( $car['pickup_data'])->format('d/m/Y') }}" id="init_car{{$key}}_{{$key1}}_{{$key2}}"  type='text' name="car_pickup_date_{{$key}}_{{$key1}}_{{$key2}}" class="th-price form-control ats-border-color checkin_date_car" placeholder="Data">
                                ...
                                <td> <!-- Pickup Hora -->
                                    <div class="form-group" style="width: 140px;">
                                        <div class="input-group date timepicker" style="position: relative;">
                                            ...
                                            <input value="{{$car['pickup_hora']}}" type="text" class="th-price form-control ats-border-color" name="car_pickup_hora_{{$key}}_{{$key1}}_{{$key2}}" placeholder="Hora">
                                            <span class="input-group-addon ats-border-color">
                                ...
                                <td>
                                    <input type="text" name="car_pickup_flight_{{$key}}_{{$key1}}_{{$key2}}" value="{{$car['pickup_flight']}}" class="form-control">
                                </td>
                                <td>
                                    <input type="text" name="car_pickup_country_{{$key}}_{{$key1}}_{{$key2}}" value="{{$car['pickup_country']}}" class="form-control">
                                </td>
                                <td>
                                    <input type="text" name="car_pickup_airport_{{$key}}_{{$key1}}_{{$key2}}" value="{{$car['pickup_airport']}}" class="form-control">
                                </td>
                                <td>
                                    <input type="text" name="car_dropoff_name_{{$key}}_{{$key1}}_{{$key2}}" value="{{$car['dropoff']}}" class="form-control">
                                </td>
                                {{-- <td>
                                    {{$car['dropoff_data']}}
                                </td>
                                ...
                                <td> <!-- Dropoff Data -->
                                    <div class="form-group" style="width: 140px;">
                                        <div class='input-group date datetimepickers{{$key}}_{{$key1}}_{{$key2}}' id='datetimepicker15' style="position: relative;">
                                            <div style="position: absolute;" id="checkout_car{{$key}}_{{$key1}}_{{$key2}}"></div>
                                            <input value="{{  Carbon\Carbon::parse( $car['dropoff_data'])->format('d/m/Y') }}" id="find_car{{$key}}_{{$key1}}_{{$key2}}" type='text' readonly name="car_dropoff_date_{{$key}}_{{$key1}}_{{$key2}}" class="th-price form-control ats-border-color" placeholder="Data">
                                            <span class="input-group-addon ats-border-color">
                                                <span class="w3-large ats-text-color fa fa-calendar"></span>
                                            </span>
                                        </div>
                                ...
                                <td> <!-- Dropoff Hora -->
                                    <div class="form-group" style="width: 140px;">
                                        <div class="input-group date timepicker" style="position: relative;">
                                            <div style="position: absolute;"></div>
                                            <input value="{{$car['dropoff_hora']}}" type="text" readonly class="th-price form-control ats-border-color" name="car_dropoff_hora_{{$key}}_{{$key1}}_{{$key2}}" placeholder="Hora">
                                            <span class="input-group-addon ats-border-color">
                                                <span class="w3-large ats-text-color fa fa-calendar">
                                                </span>
                                            </span>
                                ...
                                <td>
                                    <input type="text" name="car_dropoff_flight_{{$key}}_{{$key1}}_{{$key2}}" value="{{$car['dropoff_flight']}}" class="form-control">
                                </td>
                                {{-- <td>
                                ...
                                <td>
                                    <input type="text" name="car_group_{{$key}}_{{$key1}}_{{$key2}}" value="{{$car['group']}}" class="form-control">
                                </td>
                                <td>
                                    <input type="text" name="car_model_{{$key}}_{{$key1}}_{{$key2}}" value="{{$car['model']}}" class="form-control">
                                </td>

                                @if(in_array(Auth::user()->email, $users_array))
                                    <td>
                                        <input value="{{$car['rate']}}" id="realCar{{$key}}_{{$key1}}_{{$key2}}" onchange="somaCar({{$key}},{{$key1}},{{$key2}})" type="number" name="realCar{{$key}}_{{$key1}}_{{$key2}}" class="loaddd form-control">
                                    </td>
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        $('.datetimepicker{{$key}}_{{$key1}}_{{$key2}}').datetimepicker({widgetParent: checkin, format: 'DD/MM/YYYY', ignoreReadonly: true, widgetPositioning: { vertical: 'bottom'},}).on("dp.change", function (e) {
                                            ...
                                            mudadia($('#init_car{{$key}}_{{$key1}}_{{$key2}}').val(), $('#find_car{{$key}}_{{$key1}}_{{$key2}}').val(),'{{$key}}_{{$key1}}_{{$key2}}');
                                ...
                                @if(in_array(Auth::user()->email, $users_array))
                                    <td>
                                        <input value="{{$car['tax']}}" id="tax{{$key}}_{{$key1}}_{{$key2}}" onchange="somaCar({{$key}},{{$key1}},{{$key2}})" type="number" name="tax{{$key}}_{{$key1}}_{{$key2}}" class="loaddd form-control">
                                    </td>
                                    {{-- <td>
                                        <input value="{{$car['tax_type']}}" id="taxType{{$key}}_{{$key1}}_{{$key2}}" type="text" class="loaddd form-control" name="taxType{{$key}}_{{$key1}}_{{$key2}}">
                                    </td> --}}
                                    <td id="totalizaCar{{$key}}_{{$key1}}_{{$key2}}">0.00</td>
                                @else
                                    <td>{{$car['tax']}}</td>
                                    <td>{{$car['tax_type']}}</td>
                                    <td>{{$car['total']}}</td>
                                ...
                                @if(in_array(Auth::user()->email, $users_array))
                                    <td>
                                        <input value="{{$car['ats_rate']}}" id="atsRateCar{{$key}}_{{$key1}}_{{$key2}}" onchange="somaCar({{$key}},{{$key1}},{{$key2}})" type="number" name="atsRateCar{{$key}}_{{$key1}}_{{$key2}}" class="loaddd form-control">
                                    </td>
                                    <td id="atsTotalRateCar{{$key}}_{{$key1}}_{{$key2}}">0.00</td>
                                    <td>
                                        <span id="atsProfitCar{{$key}}_{{$key1}}_{{$key2}}">0.00</span> 
                                        <span  onclick="enviaCarsEsp('{{$car['id']}}','{{$key}}','{{$key1}}','{{$key2}}')" class="buttonn{{$key}}"></span>
                                    </td>
                                @endif 
                            </tr>
                        @endforeach
            ...
            <p>
                ...
                <table class="w3-table w3-striped w3-centered car-extras-table">
                    <tr style="background-color: #24AEC9; color: white;">
                        @if(in_array(Auth::user()->email, $users_array))
                            <th class="th-number"><span class="add-car-extras" data-key1="{{$key1}}" data-key="{{$key}}"><i class="fa fa-plus-circle fa-2x" aria-hidden="true"></i></span></th>
                        @endif
                    ...
                    <input type="hidden" class="pedido_produto_id" name="pedido_produto_id{{$key1}}" value="{{$car['pedido_produto_id']}}">
                    @foreach($extras as $key2=>$extra)
                            @if(($produto[$key][$key1]->pivot->id==$extra->pedido_produto_id) and ($extra->tipo=='cars'))
                            <input type="hidden" name="tipo{{$key}}_{{$key1}}_{{$id_extra}}" value="car" class="form-control">
                                <tr class="extra-tr">
                                <input type="hidden" name="extra_id{{$key}}_{{$key1}}_{{$id_extra}}" value="{{$extra->id}}">
                                    ...
                                    @endif
                                    <td>
                                        <input value="{{$extra->amount}}" id="car_extra_amount{{$key}}_{{$key1}}_{{$id_extra}}" onchange="somaExtra('',{{$key}},{{$key1}},{{$id_extra}},'Car')" class="form-control w3-block loaddd" type="number" name="car_extra_amount{{$key}}_{{$key1}}_{{$id_extra}}">
                                    </td>
                                    
                                    @if(in_array(Auth::user()->email, $users_array))
                                        <td>
                                            <input value="{{$extra->rate}}" id="extraRate{{$key}}_{{$key1}}_{{$id_extra}}" onchange="somaExtra('',{{$key}},{{$key1}},{{$id_extra}},'Car')" type="number" name="extraRate{{$key}}_{{$key1}}_{{$id_extra}}" class="form-control loaddd">
                                        </td>
                                        <td></td>
                                    ...
                                    @if(in_array(Auth::user()->email, $users_array))
                                        <td>
                                            <input value="{{$extra->ats_rate}}" id="atsExtraRate{{$key}}_{{$key1}}_{{$id_extra}}" onchange="somaExtra('',{{$key}},{{$key1}},{{$id_extra}},'Car')" type="number" class="loaddd form-control" name="atsExtraRate{{$key}}_{{$key1}}_{{$key2}}">
                                        </td>
                                        <td id="atsTotalExtraRate{{$key}}_{{$key1}}_{{$id_extra}}">0.00</td>
                                        <td >
                                            <span id="atsExtraProfit{{$key}}_{{$key1}}_{{$id_extra}}">0.00</span> 
                                            <span  onclick="enviaExtra('{{$extra->id}}','{{$key}}','{{$key1}}','{{$id_extra}}', 4)" data-changed="false" class="buttonn{{$key}} hidden form-control"></span>
                                        </td>
                                    @endif
                                </tr>
                                @php $id_extra++; @endphp
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <section>
                    ...
                    <div class="input-group">
                      ...
                      <input type="hidden" name="remark_geral_id" class="remark_geral_id" value="{{$car['id']}}">
                    ...
                    @if(in_array(Auth::user()->email, $users_array))
                        <button style="float: right; margin-top: 4px;" data-pedido_id='{{$car['id']}}' data-type="car" data-toggle="modal" data-target="#modal-edit-remark" aria-hidden="true" class="editremark_button btn btn-default" type="button">Edit Remark</button>
                    @endif
                ...
                <label>Calculation:</label>
                    ...
                    <div class="col-md-11">
                        ...
                        <div class="col-xs-7" style="display:{{$hidden}};">
                            <b>Kick-back</b>
                            @if(in_array(Auth::user()->email, $users_array))
                                <input value="{{$valorCar[$key][$key1]->kick}}" class="loaddd" id="kickbackCarInput{{$key}}_{{$key1}}" onchange="kickbackCar({{$key}},{{$key1}})" type="number" min="0" max="100" name="">
                                <b>%</b>
                            @endif
                        </div>
                        @if(in_array(Auth::user()->email, $users_array))
                            ...
                            <div class="col-xs-7">
                                ...
                                <input value="{{$valorCar[$key][$key1]->markup}}" class="loaddd" id="markupCarInput{{$key}}_{{$key1}}" onchange="markupCar({{$key}},{{$key1}})" type="number" min="0" max="100" name="">
                                <b>%</b>
                            </div>
                        @endif
                        ...
                        <div class="col-xs-5" style="border-top: 1px solid black;text-align: right;"">
                           ...
                           @endif
                           <span onclick="enviaCars('{{$produto[$key][$key1]->pivot->id}}','{{$key}}','{{$key1}}')" class="buttonn{{$key}}"></span>
                           <span class="hidden" id="totalProfitCar{{$key}}_{{$key1}}"></span>
                        </div>
                    </div>
                </div>
            </div>
