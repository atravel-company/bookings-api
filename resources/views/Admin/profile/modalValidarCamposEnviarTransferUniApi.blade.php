<div class="modal modal-fixed fade modal-fixed" id="modalEnviaCamposApitransferunico" tabindex="1050" role="dialog" aria-labelledby="modalEnviaCamposApitransferunicoLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-md" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalEnviaCamposApitransferunicoLabel">
                    ...
                    <div class="w3-row-padding">
                        <div class="col-xs-12" align="right">
                            <div class="form-group">
                                ...
                                <span title="Send transfers" class="w3-button w3-green EnviaDadosTransfer pull-right" style="font-size: 1em; margin-bottom: 10px; margin-top:10px">
