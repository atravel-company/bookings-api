            ...
            <div class="w3-row-padding w3-padding-32" style="border-top: 2px solid #00bad1;">
                <table width="100%" style="margin-bottom: 15px;">
                    ...
                    @foreach ($quartos->sortBy('nome')->sortBy('checkin') as $quarto)
                        ...
                        <tr>
                            <td width="30%"><b>C. in:</b> {{ Carbon\Carbon::parse($quarto->checkin)->format('d-m-Y') }}
                            </td>
                            <td width="20%"><b>C. out:</b> {{ Carbon\Carbon::parse($quarto->checkout)->format('d-m-Y') }}
                            </td>
                    ...
                    <tr>
                        ...
                        <td style="border-top: 2px solid;text-align: right;padding-right: 5px">
                ...
                <table width="100%" style="margin-bottom: 15px; border">
                    @foreach ($golfes->sortBy('nome')->sortBy('data') as $golfe)
                        ...
                        <tr>
                            ...
                            <td width="20%"><b>Starting Time:</b> {{ Carbon\Carbon::parse($golfe->hora)->format('H:i') }}
                            </td>
                    ...
                    <tr>
                        ...
                        <td style="border-top: 2px solid; text-align: right;"><b>SUBTOTAL:</b></td>
                        <td style="border-top: 2px solid;text-align: right;padding-right: 5px">
                            {{ number_format(floor($subtotal * 100) / 100, 2) }}</td>
                    </tr>
                    <tr>
                        <td colspan="3"></td>
                        <td style="border-top: 2px solid; text-align: right;"><b style="color:#FF5722">ATS RATE:</b></td>
                    ...
                    <tr>
                        <td colspan="3"></td>
                        <td style="border-top: 2px solid; text-align: right;"><b
                                style="color:green; font-weight:bold">PROFIT:</b>
                        </td>
                        <td style="border-top: 2px solid;text-align: right;padding-right: 5px">
                            {{ number_format(floor($profit * 100) / 100, 2, ',', '.') }}
                        </td>
            ...
            <div class="w3-row-padding w3-padding-32" style="border-top: 2px solid #00bad1;">
                ...
                <table width="100%" style="margin-bottom: 15px;">
                    ...
                    <tr>
                        ...
                        <td style="border-top: 2px solid; text-align: right;"><b
                                style="color:green; font-weight:bold">PROFIT:</b></td>
                        <td style="border-top: 2px solid;text-align: right;padding-right: 5px"> {{ number_format(floor($profit * 100) / 100, 2, ',', '.') }}
                        </td>
                    </tr>
                </table>
            ...
            <div class="w3-row-padding w3-padding-32" style="border-top: 2px solid #00bad1;">
                ...
                <table width="100%" style="margin-bottom: 15px;">
                    @foreach ($carros->sortBy('nome')->sortBy('pickup_data') as $carro)
                        ...
                        <tr>
                            <td><b>Drop Off Date:</b> {{ Carbon\Carbon::parse($carro->dropoff_data)->format('d-m-y') }}
                            </td>
            ...
            <table width="100%" style="margin-bottom: 15px;">
                ...
                <tr>
                    ...
                    <td width="15%" style="border-top: 2px solid;text-align: right;padding-right: 5px">
                        {{ number_format($pedido_geral->profit, 2, ',', '.') }}
                    </td>
                </tr>
                <tr>
                    <td width="60%"></td>
                ...
                @foreach ($payments as $payment)
                    <tr>
                        <td width="60%"></td>
                        <td width="25%" style="border-top: 2px solid;text-align: right;padding-right: 5px">
                ...
                <tr>
                    <td width="60%"></td>
                    <td width="25%" style="border-top: 2px solid;text-align: right;padding-right: 5px"><b>TOTAL PAID:</b>
                    </td>
                    <td width="15%" style="border-top: 2px solid;text-align: right;padding-right: 5px">
