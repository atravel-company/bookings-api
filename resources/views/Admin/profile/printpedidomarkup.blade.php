...
<div class="container">
    <div class="w3-row-padding w3-padding-32" style="border-top: 2px solid #00bad1;">
        <table width="100%" style="margin-bottom: 15px;">
            ...
            <tr>
                <td width="20%"><b>C. in:</b> {{ Carbon\Carbon::parse($quarto->checkin)->format('d-m-y') }}</td>
                <td width="22%"><b>C. out:</b> {{ Carbon\Carbon::parse($quarto->checkout)->format('d-m-y') }} </td>
...
<div class="container">
    <div class="w3-row-padding w3-padding-32" style="border-top: 2px solid #00bad1;">
        ...
        <table width="100%" style="margin-bottom: 15px;">
            ...
            <tr>
                <td width="40%"><b>Date:</b> {{ Carbon\Carbon::parse($golfe->data)->format('d-m-y') }} </td>
                <td width="40%"><b>Starting Time:</b> {{ Carbon\Carbon::parse($golfe->hora)->format('H:i') }} </td>
    ...
    <div class="w3-row-padding w3-padding-32" style="border-top: 2px solid #00bad1;">
        ...
        <table width="100%" style="margin-bottom: 15px;">
            ...
            <tr width="100%" style="margin-bottom:20px">
                <td colspan="5"> <b>Date:</b> {{ Carbon\Carbon::parse( $transfer->data )->format('d-m-y') }} |
                    <b>Time:</b> {{ Carbon\Carbon::parse( $transfer->hora)->format('H:i') }}</td>
            </tr>
            <tr>
    ...
    <div class="w3-row-padding w3-padding-32" style="border-top: 2px solid #00bad1;">
        ...
        <table width="100%" style="margin-bottom: 15px;">
            ...
            <tr>
                ...
                <td width="25%"><b>Pick-up Date:</b> {{ Carbon\Carbon::parse( $carro->pickup_data )->format('d-m-y') }}
                </td>
    ...
    <div class="w3-row-padding w3-padding-32" style="border-top: 2px solid #00bad1;">
        ...
        <table width="100%" style="margin-bottom: 15px;">
            ...
            <tr>
                ...
                <td width="25%"><b>Hour:</b> {{ Carbon\Carbon::parse( $bilhete->hora )->format('H:i') }} </td>
