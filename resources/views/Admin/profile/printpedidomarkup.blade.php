            ...
            <div class="w3-row-padding w3-padding-32" style="border-top: 2px solid #00bad1;">
                <table width="100%" style="margin-bottom: 15px;">
                    ...
                    @foreach ($quartos->sortBy('nome')->sortBy('checkin') as $quarto)
                        ...
                        <tr>
                            <td width="20%"><b>C. in:</b> {{ Carbon\Carbon::parse($quarto->checkin)->format('d-m-y') }}
                            </td>
                            <td width="22%"><b>C. out:</b> {{ Carbon\Carbon::parse($quarto->checkout)->format('d-m-y') }}
                            </td>
                ...
                <table width="100%" style="margin-bottom: 15px;">
                    @foreach ($golfes->sortBy('nome')->sortBy('data') as $golfe)
                        ...
                        <tr>
                            ...
                            <td width="40%"><b>Starting Time:</b> {{ Carbon\Carbon::parse($golfe->hora)->format('H:i') }}
                            </td>
        ...
        <div class="w3-row-padding w3-padding-28" style="border-top: 2px solid #00bad1;">
            <table width="100%" style="margin-bottom: 15px;">
                <tr>
                    ...
                    <td width="15%" style="text-align: right;padding-right: 5px"> {{ number_format($total, 2, ',', '.') }}</td>
                </tr>
                @foreach ($payments as $payment)
                    <tr>
                        <td width="60%"></td>
