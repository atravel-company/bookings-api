    ...
    <div class="w3-row-padding w3-padding-32 w3-margin-top">
        ...
        <div class="w3-col l6">
            <div class="form-group">
                ...
                {!! Form::text('nome', $produto->nome, ['class' => 'w3-input w3-border', 'style' => 'padding: 3px
                5px;']) !!}
            </div>
            ...
            <div class="form-group">
                ...
                {!! Form::textarea('descricao', $produto->descricao, ['class' => 'w3-input w3-border jqte-test', 'style'
                => ' height: 130px; resize: none; overflow-y: auto;']) !!}
            </div>
            ...
            <div class="form-group">
                ...
                <div class="w3-col l12"><input checked="checked" type="radio" onclick="javascript:yesnoCheck();"
                        name="yesno" id="noCheck" value="no">
                ...
                <div class="w3-col l12"><input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="noCheck"
                        value="no">
                    Supplier Reserve Email
                </div>
