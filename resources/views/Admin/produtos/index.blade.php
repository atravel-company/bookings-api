...
<link href="{{ asset('Admin/css/dist/cropper.css') }}" rel="stylesheet">
<style type="text/css">
    .fileUpload {
        position: relative;
        overflow: hidden;
...
<div class="w3-container">
    ...
    {!! Form::open([ 'url'=> route('produtos'), "id" => "productsSearch" ] ) !!}
    <div class="w3-center">
                                ...
                                <div class="w3-row">
                                    <div class="w3-col l1">
                                        <div class="fileUpload btn">
                                            <span onclick="fotomodal({{$produto->id}})"
                                                style="border-style: dashed; font-size: 33px">+
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div id="reload{{ $produto->id }}">
                                        <div class="reload{{ $produto->id }}">
                                                ...
                                                <div class="w3-cell-row w3-margin-bottom w3-center">
                                                    <div class="w3-container w3-section w3-cell w3-margin-bottom">
                                                        <div class="w3-col l12">
                                                            <div class="w3-col l4"><i
                                                                    onclick="fotomodaledit({{ $produto->id }},{{$imagem->id}})"
                                                                    style="cursor:pointer" class="fa fa-pencil-square-o"
                                                                    aria-hidden="true"></i></div>
                                                            <div class="w3-col l4"><i
                                                                    onclick="DeleteFoto({{$imagem->id}},{{ $produto->id }})"
                                                                    style="cursor:pointer" class="fa fa-trash"
                                                                    aria-hidden="true"></i></div>
                                                            @if($imagem->title=='principal')
                                                            <div class="w3-col l4"><i
                                                                    onclick="fotoprincipal({{$imagem->id}},{{ $produto->id }})"
                                                                    class="fa fa-star"
                                                            ...
                                                            <div class="w3-col l4"><i
                                                                    onclick="fotoprincipal({{$imagem->id}},{{ $produto->id }})"
                                                                    style="cursor:pointer" class="fa fa-star-o"
                                                                    aria-hidden="true"></i></div>
                                                            @endif
                                                        </div>
                                                        <div class="w3-col l12">
                                            ...
                                            <div id="fotomodaledit{{$produto->id}}_{{$imagem->id}}"
                                                ...
                                                <div class="w3-modal-content w3-card-4 w3-animate-opacity"
                                                    ...
                                                    <div class="w3-center"><br>
                                                        <span
                                                            onclick="closefotomodaledit({{ $produto->id }},{{$imagem->id}})"
                                                        ...
                                                        <div class="w3-container">
                                                            ...
                                                            <div class="w3-row" style="">
                                                                <div style="display: flex;">
                                                                    ...
                                                                    <div
                                                                        class="w3-col l8 w3-center w3-border  w3-padding w3-row-padding">
                                                                        ...
                                                                        <div id="result{{$produto->id}}_{{$imagem->id}}"
                                                                            ...
                                                                            <div class="alert{{$produto->id}}_{{$imagem->id}} w3-center w3-col l12"
                                                                                style="width: 300px; height: 225px; overflow: hidden; margin-left: 25%;">
                                                                            </div>
                                                                        </div>
                ...
                <form  data-field-id="{{ $produto->id }}" data-variable="{{Auth::id()}}"  action="#">
                  ...
                  @endhasallroles-->
                    ...
                    <div
                        class="w3-border-top w3-border-right w3-border-left w3-accordion-content prod-det-cont  w3-container w3-padding-16 w3-light-grey w3-border-black">
                        <b>Contracts</b>
                        <i id="" onclick="myFunction({{ $produto->id }},'brochures')"
                            class="fa fa-plus w3-right w3-button" style="font-size:18px"></i>
                            ...
                            <div class="">
                                ...
                                <div class="w3-row">
                                    <div class="w3-col l1">
                                        ...
                                        <div class="btn">
                                            <span name="" id="" onclick="createpdf({{ $produto->id }},'Brochures')"
                                                type="file" style="border-style: dashed; font-size: 33px">+</span>
                                    ...
                                    <div id="reloadpdf{{ $produto->id }}">
                                        <div class="reloadpdf{{ $produto->id }}">
                                            ...
                                            <div class="w3-col l2 w3-border"
                                                style="width: auto !important; margin-top: 2%">
                                                <div class="w3-col l12">
                                                    <div class="w3-col l4">&nbsp;</div>
                                                    <div class="w3-col l2 w3-center"><i
                                                            onclick="PdfModalEdit({{$produto->id}},{{$pdf->id}},'Brochures')"
                                                            style="cursor:pointer" class="fa fa-pencil-square-o"
                                                            aria-hidden="true"></i></div>
                                                    <div class="w3-col l2 w3-center"><i
                                                            onclick="DeletePdf({{ $produto->id }},{{$pdf->id}},'Brochures')"
                                                            style="cursor:pointer" class="fa fa-trash"
                                                            aria-hidden="true"></i></div>
                                                    <div class="w3-col l4">&nbsp;</div>
                                                </div>
                                                <div class="w3-cell-row  w3-center">
                                                    <div class="w3-container w3-section w3-cell w3-margin-bottom">
                                                        <a href="#"
                                                            ...
                                                            style="color: red;" class="fa-3x fa fa-file-pdf-o"
                                                            aria-hidden="true"></a>
                                            ...
                                            <div id="pdfeditmodalBrochures{{$produto->id}}_{{$pdf->id}}"
                                                class="w3-modal w3-animate-opacity">
                                                <div class="w3-modal-content w3-card-4 w3-animate-opacity"
                                                    ...
                                                    <div class="w3-section w3-padding"> {!! Form::label('title',
                                                        'Title:') !!}
                                                        {!! Form::text('Titlte', $pdf->title,
                                                        ['id'=>'titleBrochures'.$produto->id.'_'.$pdf->id,
                    ...
                    <div
                        class="w3-border-top w3-border-right w3-border-left w3-accordion-content prod-det-cont  w3-container w3-padding-16 w3-light-grey w3-border-black">
                        <b>Special Offers</b>
                        <i id="" onclick="myFunction({{ $produto->id }},'campaigns')"
                            class="fa fa-plus w3-right w3-button" style="font-size:18px"></i>
                            ...
                            <div class="">
                                ...
                                <div class="w3-row">
                                    <div class="w3-col l1">
                                        ...
                                        <div class="btn">
                                            <span name="" id="" onclick="createpdf({{ $produto->id }},'Campaigns')"
                                                type="file" style="border-style: dashed; font-size: 33px">+</span>
                                        ...
                                        <div class="reloadpdfcamp{{ $produto->id }}">
                                            ...
                                            <div class="w3-col l2 w3-border"
                                                ...
                                                <div class="w3-col l12">
                                                    <div class="w3-col l4">&nbsp;</div>
                                                    <div class="w3-col l2 w3-center"><i
                                                            onclick="PdfModalEdit({{$produto->id}},{{$pdf->id}},'Campaigns')"
                                                            style="cursor:pointer" class="fa fa-pencil-square-o"
                                                            aria-hidden="true"></i></div>
                                                    <div class="w3-col l2 w3-center"><i
                                                            onclick="DeletePdf({{ $produto->id }},{{$pdf->id}},'Campaigns')"
                                                            style="cursor:pointer" class="fa fa-trash"
                                                            aria-hidden="true"></i></div>
                                                    <div class="w3-col l4">&nbsp;</div>
                                                </div>
                                            ...
                                            <div id="pdfeditmodalCampaigns{{$produto->id}}_{{$pdf->id}}"
                                                class="w3-modal w3-animate-opacity">
                                                <div class="w3-modal-content w3-card-4 w3-animate-opacity"
                                                    style="max-width:600px">
                                                    ...
                                                    <div class="w3-section w3-padding"> {!! Form::label('title',
                                                        'Title:') !!}
                                                        {!! Form::text('Titlte', $pdf->title,
                                                        ['id'=>'titleCampaigns'.$produto->id.'_'.$pdf->id,
                                                        'class'=>'w3-input w3-border w3-margin-bottom']) !!}
                            ...
                            <div class="">
                                ...
                                <div class="w3-row">
                                    ...
                                    <div id="reloadExtra{{$produto->id}}">
                                        ...
                                        <div class="w3-col l2 w3-border" style="width: auto !important; margin-top: 2%">
                                            <div class="w3-row">
                                                <div class="w3-col l12">
                                                    <div class="w3-col l4">&nbsp;</div>
                                                    <div class="w3-col l2 w3-center"><i
                                                            onclick="ExtraModalEdit({{ $produto->id }},{{$extraProd->id}})"
                                                            style="cursor:pointer" class="fa fa-pencil-square-o"
                                                            aria-hidden="true"></i></div>
                                                    <div class="w3-col l2 w3-center"><i
                                                            onclick="DeleteExtra({{$produto->id}},{{ $extraProd->id }})"
                                                            style="cursor:pointer" class="fa fa-trash"
                                                            aria-hidden="true"></i></div>
                                                    <div class="w3-col l4">&nbsp;</div>
                                                </div>
                                        ...
                                        <div id="extraseditmodal{{$produto->id}}_{{$extraProd->id}}"
                                            class="w3-modal w3-animate-opacity">
                                            <div class="w3-modal-content w3-card-4 w3-animate-opacity"
                                                style="max-width:600px">
                                                ...
                                                <div class="w3-section">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="w3-container w3-section w3-cell w3-right w3-btn w3-ripple w3-blue"
                                                            onclick="create({{$produto->id}},{{$extraProd->id}});">
                                                            Create New Extra</div>
                                                        <div id="selec{{$produto->id}}_{{$extraProd->id}}">
                                                            <select name="extra"
                                                                class="w3-select w3-border w3-margin-bottom"
                                                                id="extrainput{{$produto->id}}_{{$extraProd->id}}"
                                                                style="padding: 3px 5px;">
                                                                @foreach($extras as $extra)
                                                                @if($extraProd->name==$extra->name)

                                                                <option value="{{$extra->id}}" selected="selected">
                                                                    {{$extra->name}}</option>
                                                                @else
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="typeextra"
                                                            id="typeextra{{$produto->id}}_{{$extraProd->id}}"
                                                            class="w3-select w3-border w3-margin-bottom"
                                                            style="padding: 3px 5px;">

                                                            @if($produto->alojamento==1)
                                                            @if($extraProd->pivot->formulario=='alojamento')
                                                            <option value="alojamento" selected="selected">Alojamento
                                                            </option>
                                                            @else
                                                            ...
                                                            <option value="transfer" selected="selected">Transfer
                                                            </option>
                                                            @else
                                                    ...
                                                    <span
                                                        onclick="SendExtraModalEdit({{ $produto->id }},{{$extraProd->id}})"
                                                        class="w3-button w3-block w3-blue w3-section w3-padding">Save</span>
    ...
    <div id="pdfcreatemodalBrochures{{$produto->id}}" class="w3-modal w3-animate-opacity">
        <div class="w3-modal-content w3-card-4 w3-animate-opacity" style="max-width:600px">
            ...
            {!! Form::open([ 'class'=>'w3-container', 'enctype' => "multipart/form-data" ]) !!}
            <div class="w3-section">
                ...
                <div class="form-group">
                    ...
                    <div class="w3-col l4">
                        {{ Form::checkbox('ch'.$produto->id.'[]',$role->id,null,['class'=>'w3-checkbox']) }}
                        {{$role->name}}
                    </div> @endforeach
                    <br><br>
                    <!-- </select> -->
    ...
    <div id="fotomodal{{$produto->id}}" class="w3-modal w3-animate-opacity">
        <div class="w3-modal-content w3-card-4 w3-animate-opacity" style="width:995px">
            ...
            <div class="w3-center"><br>
                <span onclick="closefotomodal({{$produto->id}})"
                    class="w3-button w3-xlarge w3-hover-red w3-display-topright" title="Close Modal">&times;</span>
            </div>
            <div class="w3-section">
                <div class="w3-container">
                    ...
                    <div class="w3-row" style="">
                        <div style="display: flex;">
                            <div class="w3-col l4 w3-center w3-border  w3-padding w3-row-padding-32"
                                ...
                                <div class="img-container">
                                    ...
                                    <div class="w3-col l12"><img class="w3-padding w3-margin-top w3-margin-bottom"
                                            id="image{{$produto->id}}" src="<?php echo asset("storage/padrao.png")?>"
                                            alt="Picture"></div>
                                </div>
                            </div>
                            <div class="w3-col l8 w3-center w3-border  w3-padding w3-row-padding">
                                ...
                                <div id="result{{$produto->id}}" class="w3-margin-top w3-margin-bottom"
                                    style="overflow: auto;">
                                    <div class="w3-col l12">
                                        <h3>Preview</h3>
                                    </div>
                        ...
                        <div class=" w3-col l12 w3-border">
                            <span style="display: block;" onclick="redim({{$produto->id}})"
                                id="redimbtn{{$produto->id}}" class="w3-button w3-orange w3-block">Redim</span>
                        </div>
                        <div class="w3-col l12 w3-border">
                            <span style="display: none;" id="button{{$produto->id}}"
                                class="w3-button w3-blue w3-block">Save</span>
                        </div>
    ...
    <div id="extrascreatemodal{{$produto->id}}" class="w3-modal w3-animate-opacity">
        <div class="w3-modal-content w3-card-4 w3-animate-opacity" style="max-width:600px">
            ...
            <div class="w3-center"><br>
                <span
                    onclick="document.getElementById('extrascreatemodal{{$produto->id}}').style.display='none'; modal=0;"
                    class="w3-button w3-xlarge w3-hover-red w3-display-topright" title="Close Modal">&times;</span>
            ...
            <div class="w3-container w3-section w3-cell w3-margin-bottom w3-center"
                id="extracreateerror{{$produto->id}}">
            </div>
                ...
                <div class="form-group">
                    ...
                    <div id="selec{{$produto->id}}_0">
                        <select name="extra" class="w3-select w3-border w3-margin-bottom"
                            id="extrainput{{$produto->id}}" style="padding: 3px 5px;">
                            @foreach($extras as $extra)
                            <option value="{{$extra->id}}">{{$extra->name}}</option>
                            @endforeach
                        </select>
            ...
            <div class="w3-row-padding w3-padding-32 w3-margin-top">
                <div class="w3-col l12">
                    <div class="form-group">
                        ...
                        {!! Form::text('name', null, ['id'=>'nameextra','class'=>'w3-input w3-border',
                        'style'=>'padding: 3px
                        5px;']) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::textarea('description', null, ['id'=>'textextra' ,'class'=>'w3-input w3-border',
                        'style'=>'
