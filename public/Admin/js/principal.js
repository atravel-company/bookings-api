                ...
                success: function(data) {
                    ...
                    if (data.result.suppliers == 'Vazio!') {
                        ...
                        for (var key in data.result.produtos) {
                            ...
                            $('#resultado').append('<a href="https://atsportugal.com/admin/main/product/' + data.result.produtos[key].id + '/' + categoria_id + '/' + destino_id + '"><div class="w3-col l12" style=" border-color: #eeeeee; border-style: solid; border-width: 1px;"><div class="w3-col l1" style="background-color: #F6F6F6; "><img style="max-height: 35px; max-width: 69px;"  class="w3-block" src="https://atsportugal.com/storage/' + supplier_path_image + '" ></div><div class="w3-col l10" style="background-color: #F6F6F6;"><div style=" padding-top: 7px;"><span style="color: #888888;">' + data.result.produtos[key].nome + '</span><span style=" color: #24AEC9;">&nbsp;-&nbsp;' + data.result.destinos[key].name + '</span></div></div><div class="w3-col l1 " style="background-color: #F6F6F6;"><button style="height: 35px; background-color: #24AEC9; color:white;" class="w3-button w3-tiny w3-block">Details</button></div></div></a>');
                        }
                    }
                },
                error: function(jqXHR, textStatus, errorThrown) {
