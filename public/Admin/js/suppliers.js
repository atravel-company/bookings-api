  ...
  var val = {'search':search};
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          // $('#supp').load('suppliers/lista', {'list': armaz},function(variavel){
        ...
        success: function(data){
          ...
          for (i = 0; i < data.result.account.length; ++i) {
            data.result.account[i].forEach(function(acc) {
              $('#acc'+acc.id).empty();
              $('#acc'+acc.supp_bank_acc_dest_id).append('<tr><th class="w3-text-teal">'+acc.type+'</th><td>'+acc.account_number+'<a title="Delete Account" onclick="bankaccountdel('+ids+','+acc.id+')" class="w3-right"><i style="color:teal" class="fa fa-eraser w3-right w3-button" aria-hidden="true"></i></a>'+'</td></tr>');
            });
          }
...
function bankaccountdel(valID,valIDdest) {
  ...
  var val = {'id':ids,'IdAccount':valIDdest};
      ...
      $.ajax({
        type:'GET',
        url:"suppliers/bankaccountdestroy",
        data:val,
        success: function(data){
  ...
  $.ajax({
    ...
    success: function(data){
      ...
      for (i = 0; i < data.result.account.length; ++i) {
        data.result.account[i].forEach(function(acc) {
          $('#acc'+acc.id).empty();
          $('#acc'+acc.supp_bank_acc_dest_id).append('<tr><th class="w3-text-teal">'+acc.type+'</th><td>'+acc.account_number+'<a title="Delete Account" onclick="bankaccountdel('+id+','+acc.id+')" class="w3-right"><i style="color:teal" class="fa fa-eraser w3-right w3-button" aria-hidden="true"></i></a>'+'</td></tr>');
        });
      }
  ...
  $.ajax({
    ...
    success: function(data){
      ...
      //$('#myDIVcontact'+id).append('<button  onclick="bankcreate('+id+')" class="fa fa-plus w3-right" style="color:teal" aria-hidden="true"></button>');
          $('#tablecontracts'+supID).append('<tr><th class="w3-text-teal" style="width:25%">Name</th><th class="w3-text-teal" style="width:25%">Phone</th><th class="w3-text-teal" style="width:25%">E-mail</th><th class="w3-text-teal" style="width:25%">Mobile</th></tr>');
          $('#tablereservations'+supID).append('<tr><th class="w3-text-teal" style="width:25%">Name</th><th class="w3-text-teal" style="width:25%">Phone</th><th class="w3-text-teal" style="width:25%">E-mail</th><th class="w3-text-teal" style="width:25%">Mobile</th></tr>');
          $('#tableaccounts'+supID).append('<tr><th class="w3-text-teal" style="width:25%">Name</th><th class="w3-text-teal" style="width:25%">Phone</th><th class="w3-text-teal" style="width:25%">E-mail</th><th class="w3-text-teal" style="width:25%">Mobile</th></tr>');
...
function contato(id){
  ...
  $.ajax({
    ...
    success: function(data){
      ...
      $('#tablecontracts'+id).append('<tr><th class="grid_title_3" style="width:25%;">Name</th><th class="grid_title_3" style="width:25%;">Phone</th><th class="grid_title_3" style="width:25%;">E-mail</th><th class="grid_title_3" style="width:25%;">Mobile</th></tr>');
      $('#tablereservations'+id).append('<tr><th class="grid_title_3">Name</th><th class="grid_title_3">Phone</th><th class="grid_title_3">E-mail</th><th class="grid_title_3">Mobile</th></tr>');
      $('#tableaccounts'+id).append('<tr><th class="grid_title_3">Name</th><th class="grid_title_3">Phone</th><th class="grid_title_3">E-mail</th><th class="grid_title_3">Mobile</th></tr>');
      data.result.contact.forEach(function(dest) {
        if(dest.type=='Contracts'){
          $('#tablecontracts'+id).append('<tr>'+'<td class="grid_3">'+dest.name+'</td><td class="grid_3">'+dest.telephone+'</td>'+'<td class="grid_3">'+dest.email+'</td>'+'<td class="grid_3">'+dest.mobile+'<a title="Delete Contract" onclick="destroycontact('+dest.id+','+id+','+0+')" class="w3-button fa fa-eraser w3-right" style="color:teal" aria-hidden="true"></a>'+'</td>'+'</tr>');
        }
        else if(dest.type=='Reservations'){
          $('#tablereservations'+id).append('<tr>'+'<td class="grid_3">'+dest.name+'</td><td class="grid_3">'+dest.telephone+'</td>'+'<td class="grid_3">'+dest.email+'</td>'+'<td class="grid_3">'+dest.mobile+'<button title="Delete Reservations" onclick="destroycontact('+dest.id+','+id+','+1+')" class="w3-right"><i style="color:teal" class="fa fa-eraser w3-right" aria-hidden="true"></i></button>'+'</td>'+'</tr>');

        }
        else if(dest.type=='Accounts'){
          $('#tableaccounts'+id).append('<tr>'+'<td class="grid_3">'+dest.name+'</td><td class="grid_3">'+dest.telephone+'</td>'+'<td class="grid_3">'+dest.email+'</td>'+'<td class="grid_3">'+dest.mobile+'<button title="Delete Accounts" onclick="destroycontact('+dest.id+','+id+','+2+')" class="w3-right"><i style="color:teal" class="fa fa-eraser w3-right" aria-hidden="true"></i></button>'+'</td>'+'</tr>');
...
//---------------------------------------------------------------------------------------------//
    if(modal.id=='bankcreateaccount'){
      ...
      $.ajax({
        type:'POST',
        url:"suppliers/bankcreateaccount",
        data:val,
        success: function(data){
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          for (i = 0; i < data.result.account.length; ++i) {
            data.result.account[i].forEach(function(acc) {
              $('#acc'+acc.id).empty();
              $('#acc'+acc.supp_bank_acc_dest_id).append('<tr><th class="w3-text-teal">'+acc.type+'</th><td>'+acc.account_number+'<a title="Delete Account" onclick="bankaccountdel('+idsupdt+','+acc.id+')" class="w3-right"><i style="color:teal" class="fa fa-eraser w3-right w3-button" aria-hidden="true"></i></a>'+'</td></tr>');
            });
          }
    ...
    if(modal.id=='contactedit'){
      ...
      var val = {'id':idsupdt,'idcontact':idcontact,'type':type,'name':name, 'phone':phone, 'email':email, 'mobile':mobile};
        ...
        window.setTimeout(function(){
          ...
          //$('#myDIVcontact'+id).append('<button  onclick="bankcreate('+id+')" class="fa fa-plus w3-right" style="color:teal" aria-hidden="true"></button>');
              $('#tablecontracts'+idsupdt).append('<tr><th class="w3-text-teal" style="width:25%">Name</th><th class="w3-text-teal" style="width:25%">Phone</th><th class="w3-text-teal" style="width:25%">E-mail</th><th class="w3-text-teal" style="width:25%">Mobile</th></tr>');
              $('#tablereservations'+idsupdt).append('<tr><th class="w3-text-teal" style="width:25%">Name</th><th class="w3-text-teal" style="width:25%">Phone</th><th class="w3-text-teal" style="width:25%">E-mail</th><th class="w3-text-teal" style="width:25%">Mobile</th></tr>');
              $('#tableaccounts'+idsupdt).append('<tr><th class="w3-text-teal" style="width:25%">Name</th><th class="w3-text-teal" style="width:25%">Phone</th><th class="w3-text-teal" style="width:25%">E-mail</th><th class="w3-text-teal" style="width:25%">Mobile</th></tr>');
              data.result.contact.forEach(function(dest) {
                if(dest.type=='Contracts'){
              ...
              $.notify(
                "Contacts edited successful", 'info',
              );
...
//---------------------------------------------------------------------------------------------//
    if(modal.id=='createcontact'){
      ...
      //$('#myDIVcontact'+id).append('<button  onclick="bankcreate('+id+')" class="fa fa-plus w3-right" style="color:teal" aria-hidden="true"></button>');
          $('#tablecontracts'+ids).append('<tr><th class="w3-text-teal" style="width:25%">Name</th><th class="w3-text-teal" style="width:25%">Phone</th><th class="w3-text-teal" style="width:25%">E-mail</th><th class="w3-text-teal" style="width:25%">Mobile</th></tr>');
          $('#tablereservations'+ids).append('<tr><th class="w3-text-teal" style="width:25%">Name</th><th class="w3-text-teal" style="width:25%">Phone</th><th class="w3-text-teal" style="width:25%">E-mail</th><th class="w3-text-teal" style="width:25%">Mobile</th></tr>');
          $('#tableaccounts'+ids).append('<tr><th class="w3-text-teal" style="width:25%">Name</th><th class="w3-text-teal" style="width:25%">Phone</th><th class="w3-text-teal" style="width:25%">E-mail</th><th class="w3-text-teal" style="width:25%">Mobile</th></tr>');
          data.result.contact.forEach(function(dest) {
            if(dest.type=='Contracts'){
