...
function fotoprincipal(id, prodID) {
    ...
    $.ajax({
        type: 'GET',
        url: window.location.origin + "/admin/produtos/fotoprincipal",
        data: val,
...
function DeleteFoto(id, prodID) {
    ...
    $.ajax({
        type: 'GET',
        url: window.location.origin + "/admin/produtos/fotodel",
        data: val,
        success: function (data) {
            caminho = window.location.href + " .reload" + prodID;
...
function redimedit(id, fotoID) {
    ...
    button.onclick = function () {
        ...
        $.ajax({
            type: 'POST',
            url: window.location.origin + "/admin/produtos/fotoedit",
            data: fd,
            contentType: false,
            processData: false,
            cache: false,
...
function redim(id) {
    ...
    button.onclick = function () {
        ...
        $.ajax({
            type: 'POST',
            url: window.location.origin + "/admin/produtos/foto",
            data: fd,
            contentType: false,
            processData: false,
            cache: false,
...
function DeleteExtra(id2, extraId2) {
    ...
    $.ajax({
        type: 'GET',
        url: window.location.origin + "/admin/produtos/extradel",
        data: val,
        success: function (data) {
            modal = 0;
...
function SendExtraModalEdit(id, ExtraID) {
    ...
    $.ajax({
        type: 'POST',
        url: window.location.origin + "/admin/produtos/editextra",
        data: val,
        success: function (data) {
            modal = 0;
            console.log(data);
...
function PdfModalEdit(id2, pdfId2, type1) {
    ...
    button.onclick = function () {
        ...
        $.ajax({
            type: 'POST',
            url: window.location.origin + "/admin/produtos/pdfedit",
            data: form,
            processData: false,
            contentType: false,
            success: function (data) {
...
function DeletePdf(id, pdfId2, type) {
    ...
    $.ajax({
        type: 'GET',
        url: window.location.origin + "/admin/produtos/pdfdel",
        data: val,
        success: function (data) {
...
function sendpdf(id1, type1) {
    ...
    button.onclick = function () {
        ...
        $.ajax({
            type: 'POST',
            url: window.location.origin + "/admin/produtos/pdf",
            data: form,
            processData: false,
            contentType: false,
            success: function (data) {
...
$(document).ready(function () {
    ...
    $('form#productsSearch').on('submit', function (e) {
        e.preventDefault();
        if (modal == 0) {
            var nme = $('#searchname').val();
            var adress = window.location.origin + '/admin/produtos' + '?nome=' + nme;
    ...
    $('form:not(#productsSearch)').on('submit', function (e) {
        ...
        if (modal == 'extrascreatemodal') {
            ...
            $.ajax({
                type: 'POST',
                url: window.location.origin + "/admin/produtos/addextra",
                data: val,
                success: function (data) {
                    modal = 0;
                    console.log(data);
        ...
        if (modal == 'createmodal') {
            ...
            $.ajax({
                type: 'POST',
                url: window.location.origin + "/admin/extras/store",
                data: val,
                success: function (data) {
...
function searchProduto() {
    ...
    $.ajax({
        type: 'get',
        url: window.location.origin + "/admin/produtos/search",
        data: val,
        success: function (data) {
...
function changeState(produto_id, estado) {
    $.ajax({
        type: 'POST',
        url: window.location.origin + "/admin/produtos/changestate",
        dataType: "json",
        data: $.param({
