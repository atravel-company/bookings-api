...
Route::group(["prefix" => "admin", 'middleware' => ['auth']], function () {
	...
	Route::group(['prefix'=>'reports'], function() {
		...
		Route::get('search',['as'=>'reports.search', 'uses'=>'ReportsController@search']);
		Route::post('report',['as'=>'reports.report', 'uses'=>'ReportsController@report']);
	});

	Route::get('pedidosreports',['as'=>'pedidosreports', 'uses'=>'PedidosReportsController@index']);
	Route::get('pedidosreports/ats',['as'=>'pedidosreports/ats', 'uses'=>'PedidosReportsController@index']);
	Route::post('pedidosreports.search',['as'=>'pedidosreports.search', 'uses'=>'PedidosReportsController@search']);
	Route::post('pedidosreports.search/ats',['as'=>'pedidosreports.search/ats', 'uses'=>'PedidosReportsController@search']);

	Route::get('proforma',['as'=>'proforma', 'uses'=>'PedidosReportsController@proforma']);
	Route::get('reports/pedidosreports/print/',['as'=>'reports.pedidosreports.print.', 'uses' => 'PedidosReportsController@PrintPedido']);
	...
	Route::group(['prefix'=>'profile'], function() {
		...
		Route::match(['get', 'post'], 'download/excel/roomslist/{id}',['as'=>'profile.download.excel.roomlist', 'uses'=>'ProfilesController@excelRoomsList']);
